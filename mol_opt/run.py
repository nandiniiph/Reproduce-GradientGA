...
def main(method,oracle_name):
    ...
    if args.task != "tune":
        ...
        for oracle_name in args.oracles:
            ...
            oracle.name = oracle_name  # Penting agar evaluator tahu nama oracle

            # Assign evaluator dari TDC sesuai oracle_name
            from tdc import Oracle as TDCOracle
            oracle.assign_evaluator(TDCOracle(name=oracle_name))
